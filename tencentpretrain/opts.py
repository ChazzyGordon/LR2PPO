...
def training_opts(parser):
    ...
    parser.add_argument("--max_imgs", type=int, default=32,
                        help="number of visual feats")
    parser.add_argument("--visual_feat_dim", type=int, default=-1,
                        help="dim of visual feats")
